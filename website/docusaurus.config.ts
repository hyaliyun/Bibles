...
if (isSlower) {
  console.log('🐢 Using slower 中国基督教 build');
}
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/Bible/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/Bible/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/Bible/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
    ...
    themeConfig: {
      ...
      navbar: {
        ...
        items: [
          ...
          // Right
          {to: 'swap', label: '奉献', position: 'right'},
          {
            type: 'localeDropdown',
            position: 'right',
            dropdownItemsAfter: [
          ...
          {
            href: 'https://github.com/hyaliyun/Bible',
            position: 'right',
      ...
      footer: {
        ...
        logo: {
          ...
          src: '/img/head-logo.jpg',
          href: 'https://www.543x.com',
        },
        copyright: `Copyright © ${new Date().getFullYear()} 中国基督教`,
      },
